...
export interface ApiBookingBooking extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A reservation period for a room';
    displayName: 'Booking';
    pluralName: 'bookings';
  ...
  attributes: {
    ...
    date_to: Schema.Attribute.Date & Schema.Attribute.Required;
    guest_note: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking.booking'
...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "A room in the monastery's guest wing";
    displayName: 'Room';
    pluralName: 'rooms';
    singularName: 'room';
  };
